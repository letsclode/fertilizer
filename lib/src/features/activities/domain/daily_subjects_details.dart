...
class DailySubjectDetails {
  DailySubjectDetails({required this.date, required this.jobsDetails});
  final DateTime date;
  final List<SubjectDetails> jobsDetails;
  ...
  // static Map<DateTime, List<ActivitySubject>> _entriesByDate(
  //     List<ActivitySubject> activities) {
  //   final Map<DateTime, List<ActivitySubject>> map = {};
  //   for (final activitySubject in activities) {
  //     final entryDayStart = DateTime(activitySubject.activity.start.year,
  //         activitySubject.activity.start.month, activitySubject.activity.start.day);
